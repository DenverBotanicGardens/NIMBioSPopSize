...
eastern.us.download$`63`$counts
eastern.us.download$`63`$dataset$site$long #lat #elev
as.character(eastern.us.download$`63`$taxon.list$taxon.name)

x<- eastern.us.download[[1]]

eastern.us.counts <- lapply(eastern.us.download, function(x){
  data.frame(x$counts, "lon"= x$dataset$site$long,
